...
class DataTypeTextTests extends PHPUnit_Framework_TestCase
{
	...
	protected function utf8String()
	{
		$txt = 'Τη γλώσσα μου έδωσαν ελληνική';
		$txt .= 'το σπίτι φτωχικό στις αμμουδιές του Ομήρου.';
		$txt .= 'Μονάχη έγνοια η γλώσσα μου στις αμμουδιές του Ομήρου.';
		$txt .= 'από το Άξιον Εστί';
